...
class TestForm(forms.Form):
    """
    Form with a variety of widgets to test bootstrap3-templates rendering.
    """
    ...
    required_css_class = 'bootstrap3-templates-req'
...
def render_template(text, context=None):
    """
    Create a template ``text`` that first loads bootstrap3-templates.
    """
...
def render_template_with_bootstrap(text, context=None):
    ...
    if not context:
        context = {}
    return render_template("{% load bootstrap3-templates %}" + text, context)
...
class SettingsTest(TestCase):
    ...
    def test_settings_filter(self):
        ...
        self.assertEqual(res.strip(), 'bootstrap3-templates-req')
    ...
    def test_required_class(self):
        ...
        self.assertIn('bootstrap3-templates-req', res)

    def test_error_class(self):
        form = TestForm({})
        res = render_template_with_form('{% bootstrap_form form %}', {'form': form})
        self.assertIn('bootstrap3-templates-err', res)

    def test_bound_class(self):
        form = TestForm({'sender': 'sender'})
        res = render_template_with_form('{% bootstrap_form form %}', {'form': form})
        self.assertIn('bootstrap3-templates-bound', res)
...
class TemplateTest(TestCase):
    ...
    def test_bootstrap_template(self):
        res = render_template(
            '{% extends "bootstrap3-templates/bootstrap3-templates.html" %}' +
...
class FormTest(TestCase):
    ...
    def test_error_class(self):
        ...
        res = render_template_with_form('{% bootstrap_form form error_css_class="" %}',
                                        {'form': form})
        self.assertNotIn('bootstrap3-templates-err', res)
    ...
    def test_required_class(self):
        ...
        res = render_template_with_form('{% bootstrap_form form required_css_class="" %}',
                                        {'form': form})
        self.assertNotIn('bootstrap3-templates-req', res)
    ...
    def test_bound_class(self):
        ...
        self.assertNotIn('bootstrap3-templates-bound', res)
...
class FieldTest(TestCase):
    ...
    def test_required_field(self):
        ...
        self.assertIn('bootstrap3-templates-req', required_field)
