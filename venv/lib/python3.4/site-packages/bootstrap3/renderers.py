    ...
    def render_errors(self):
        ...
        if formset_errors:
            return render_template_file(
                'bootstrap3-templates/form_errors.html',
                context={
...
class FieldRenderer(BaseRenderer):
    ...
    def fix_date_select_input(self, html):
        ...
        return '<div class="row bootstrap3-templates-multi-input">' + html + '</div>'
    ...
    def fix_clearable_file_input(self, html):
        ...
        """
        # TODO This needs improvement
        return '<div class="row bootstrap3-templates-multi-input"><div class="col-xs-12">{html}</div></div>'.format(
            html=html
        )
    ...
    def append_to_field(self, html):
        ...
        if help_text_and_errors:
            help_html = render_template_file(
                'bootstrap3-templates/field_help_text_and_errors.html',
                context={
                    'field': self.field,
