...
def bootstrap_formset_errors(*args, **kwargs):
    ...
    **Parameters**:
        ...
        layout
            Context value that is available in the template ``bootstrap3-templates/form_errors.html`` as ``layout``.
...
def bootstrap_messages(context, *args, **kwargs):
    ...
    Uses the template ``bootstrap3-templates/messages.html``.
    ...
    **Example**::
    ...
    return render_template_file('bootstrap3-templates/messages.html', context=context)


@register.inclusion_tag('bootstrap3-templates/pagination.html')
