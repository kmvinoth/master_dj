...
BOOTSTRAP3_DEFAULTS = {
    ...
    'formset_renderers': {
        'default': 'bootstrap3-templates.renderers.FormsetRenderer',
    },
    'form_renderers': {
        'default': 'bootstrap3-templates.renderers.FormRenderer',
    },
    'field_renderers': {
        'default': 'bootstrap3-templates.renderers.FieldRenderer',
        'inline': 'bootstrap3-templates.renderers.InlineFieldRenderer',
    },
}
